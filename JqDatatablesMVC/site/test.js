...
var TableInit = function () {
    ...
    var initMainTable = function (jData) {
        ...
        function format(d) {
            ...
            return '<table id="' + xd + '" class="table table-condensed table-responsive table-striped table-bordered table-hover" style="white-space: nowrap;">'
                +'      <thead>'
                +'          <tr>'
                +'              <th>OrderID</th>'
                +'              <th>CustomerID</th>'
        ...
        var oTable = table.dataTable({
            ...
            "tableTools": {
                ...
                "aButtons": [{
                    ...
                    "sExtends": "csv",
                    "sButtonText": "<i class='fa fa-file-code-o'></i> CSV"
                }, {
                    "sExtends": "xls",
