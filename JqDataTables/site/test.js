...
var TableInit = function () {
    var initMainTable = function () {
        ...
        var oTable = table.dataTable({
            ...
            "dom": 'T<"clear">lfrtip',
            //"dom": "<'col-md-12'T>",
            //"dom": "<'row' <'psthere'T>><'row'<'col-md-6 col-sm-12'l><'col-md-6 col-sm-12'f>r><'table-scrollable't><'row'<'col-md-5 col-sm-12'i><'col-md-7 col-sm-12'p>>", // horizobtal scrollable datatable
            "tableTools": {
